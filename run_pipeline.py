import argparse, os
from src.postprocess_pipeline import run_file_with_progress
...
def main():
    ...
    run_file_with_progress(args.input, args.output, args.names, onnx_model_path=args.onnx, device=args.device)
