...
class PostProcessor:
    ...
    def process_one(self, text: str) -> str:
        ...
        # IMPROVED: Better punctuation heuristic
...
def run_file_with_progress(input_path: str, output_path: str, names_lex_path: str, onnx_model_path: str = None, device: str = "cpu", max_length: int = 64):
    ...
    for r in tqdm(rows, desc="Post-processing", unit="sample"):
        pred = pp.process_one(r["text"])
        out.append({"id": r["id"], "text": pred})
